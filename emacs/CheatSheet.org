...
| ~M-$n$~ | select the $n$-th suggestion in company mode |
...
| ~⎇-⌘-P~       | move focus to counter clockwise screen                   |
| ~⎇-⌘-N~       | move focus to clockwise screen                           |
| ~⎇-⇧-⌘-H~     | swap focused window to counter clockwise screen          |
| ~⎇-⇧-⌘-L~     | swap focused window to clockwise screen                  |
| ~⎇-⇧-⌘-J~     | swap focused window counter clockwise                    |
| ~⎇-⇧-⌘-K~     | swap focused window clockwise                            |
| ~⎇-⌘-Z~       | force windows to be reevaluated                          |
| ~⎇-⇧-⌘-←~     | throw focused window to space left                       |
| ~⎇-⇧-⌘-→~     | throw focused window to space right                      |
| ~⎇-⇧-⌘-n~     | throw focused window to space n, $n \in \{0, \dots, 9\}$ |
| ~⎇-⌘-W~       | focus screen 1                                           |
